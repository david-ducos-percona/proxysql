...
class Query_Processor {
	...
	std::map<long long, std::vector<QP_rule_t *>*> map_rules;
	...
	void update_query_rules(std::vector<QP_rule_t *> *qrv, std::vector<QP_rule_t *> *rules );
	void update_mapped_query_rules(std::map<long long int, std::vector<QP_rule_t *>*>* qrm, std::vector<QP_rule_t *>* rules);
